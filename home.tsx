...
type clsNames = 'appFrame' | 'appBar' | 'appBarShift' | 'menuButton' | 'hide' |
    'content' | 'content-left' | 'contentShift' | 'contentShift-left' | 'drawerHeader' |
    'drawerPaper';
...
interface IHomeProps extends RouteComponentProps<any>, WithStyles<clsNames> {
    app: IApp
}
...
class Home extends React.Component<IHomeProps, IHomeState> {
    ...
    public render() {
        const { classes, theme, app } = this.props;
