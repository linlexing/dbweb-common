...
const doToggleLangMenu = createAction('[home]doToggleLangMenu', resolve => (open: boolean) => resolve(open));
...
export { doOpenMenu, doHideMenu, doOpenMenuList, doCloseMenuList, doToggleUserMenu, doToggleLangMenu };
